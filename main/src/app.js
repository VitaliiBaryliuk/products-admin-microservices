...
typeorm_1.createConnection().then(function (db) {
    ...
    amqp.connect('amqps://yahfrnbv:7iiBA9qgiG3msMZgA6go5zrh3Aa0ebnx@cow.rmq2.cloudamqp.com/yahfrnbv', function (error0, connection) {
        if (error0)
            throw error0;
            ...
            app.get('/api/products/:id/like', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            product = _a.sent();
                            return [4 /*yield*/, axios_1.default.post("http://localhost:8001/api/products/" + product.admin_id + "/like", {})];
                        case 2:
                            _a.sent();
                            product.likes++;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, productRespository.delete({ admin_id: admin_id })];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
